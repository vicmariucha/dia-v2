...
const isEqual = (a: PatientData, b: PatientData) => JSON.stringify(a) === JSON.stringify(b);
...
const Perfil = () => {
  // Mock inicial (trocar por dados reais)
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="max-w-md mx-auto px-6 -mt-4 space-y-4">
              ...
              valueNode={
                isEditing ? (
                  <AppTextField
                    ...
                    onChange={(e) => setEdited((p) => ({ ...p, birthDate: e.target.value }))}
                  />
                ) : (
        ...
        <InfoCard>
          <div className="mb-2">
            <h2 className="text-base font-semibold text-foreground">Dados de saúde</h2>
            <p className="text-xs text-muted-foreground">Diabetes e tratamento</p>
          </div>
              ...
              valueNode={
                isEditing ? (
                  <select
                    ...
                    onChange={(e) =>
                      setEdited((p) => ({ ...p, diabetesType: e.target.value as PatientData["diabetesType"] }))
                    }
                  ...
                  <p className="text-sm font-medium text-foreground">{data.diabetesType}</p>
                )
              }
            />
              ...
              valueNode={
                isEditing ? (
                  <select
                    ...
                    onChange={(e) =>
                      setEdited((p) => ({ ...p, treatment: e.target.value as PatientData["treatment"] }))
                    }
                    className="w-full bg-card border border-border rounded-3xl py-3.5 px-4 text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-smooth"
                  >
                  ...
                  <p className="text-sm font-medium text-foreground">{data.treatment}</p>
                )
              }
            />
              ...
              valueNode={
                isEditing ? (
                  <select
                    ...
                    onChange={(e) =>
                      setEdited((p) => ({ ...p, glucoseChecks: e.target.value as PatientData["glucoseChecks"] }))
                    }
                    className="w-full bg-card border border-border rounded-3xl py-3.5 px-4 text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-smooth"
                  >
                  ...
                  <p className="text-sm font-medium text-foreground">{data.glucoseChecks} vezes</p>
                )
              }
            />
              ...
              valueNode={
                isEditing ? (
                  <select
                    ...
                    onChange={(e) => setEdited((p) => ({ ...p, bolusInsulin: e.target.value }))}
                    className="w-full bg-card border border-border rounded-3xl py-3.5 px-4 text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-smooth"
                  >
                  ...
                  <p className="text-sm font-medium text-foreground">{data.bolusInsulin}</p>
                )
              }
            />
              ...
              valueNode={
                isEditing ? (
                  <select
                    ...
                    onChange={(e) => setEdited((p) => ({ ...p, basalInsulin: e.target.value }))}
                    className="w-full bg-card border border-border rounded-3xl py-3.5 px-4 text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-smooth"
                  >
                    <option value="">Selecione...</option>
                  ...
                  <p className="text-sm font-medium text-foreground">{data.basalInsulin}</p>
                )
              }
            />
          </div>
